...
/***/ function(module, exports, __webpack_require__) {
	...
	new _vue2.default({
	  ...
	  render: function render(h) {
	    return h('<div class="test">Dbt</div>');
	  }
	}); /**
	     * Des
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getData = __webpack_require__(76);

	var _getData2 = _interopRequireDefault(_getData);

	var _moment = __webpack_require__(77);
	...
	exports.default = {
	    state: {
	        ...
	        type: 'DBT_left',
	        prevUpdateTime: (0, _moment2.default)().format('YYYY-MM-DD HH:mm:ss'), //上一次更新时间
	        lastUpdateTime: (0, _moment2.default)().format('YYYY-MM-DD HH:mm:ss'), //最后一次更新时间
	        data: {
	            "promote": [],
	            "articleList": []
	        }
	    ...
	    mutations: {
	        updateState: function updateState(state, newData) {
	            state.status = 'update';
	            state.data = _immutable2.default.fromJS(state.data).mergeDeep(_immutable2.default.fromJS(newData)).toJS();
	            state.prevUpdateTime = state.lastUpdateTime;
	            state.lastUpdateTime = (0, _moment2.default)().format('YYYY-MM-DD HH:mm:ss');
	        },
	        completeState: function completeState(state, fn) {
	    ...
	    actions: {
	        updateData: function () {
	            var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref, cbFn) {
	                ...
	                return _regenerator2.default.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                _context.next = 2;
	                                return (0, _getData2.default)('../../src/data/dbt/left.json');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (url, json) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "E:\\more and more\\VUE\\12-Vuex\\myApp\\src\\component\\dbt\\index.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-3ca3e1ce", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-3ca3e1ce", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _left = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "E:\\more and more\\VUE\\12-Vuex\\myApp\\src\\component\\dbt\\left.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-3484898a", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-3484898a", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] left.vue: functional components are not supported and should be defined in plain js files using render functions.")}
	...
	exports.default = {
	    computed: (0, _extends3.default)({}, (0, _vuex.mapState)({
	        data: function data(state) {
	            return state.DBT_left.data;
	        }
	    })),
	    mounted: function mounted() {
	        this.$store.dispatch('updateData', function (data) {
	            console.log(data);
	        });
	    }
	}; //
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  return _h('div', [_h('div', {
	  ...
	  }, [_vm._l((_vm.data.promote), function(item, i) {
	    return _h('li', {
	      key: i
	    }, [_h('a', {
	      attrs: {
	    ...
	    staticClass: "item_list"
	  }, [_vm._l((_vm.data.articleList), function(item, i) {
	    return _h('li', {
	      key: i,
	      class: i == 0 ? 'first' : ''
	    }, [_h('a', {
	      attrs: {
	        ...
	        "target": "_blank",
	        "title": item.title,
	        "clstag": 'jr|keycount|newbthome|dbthdlist' + (i + 1)
	      }
	    }, [_h('em', ["[" + _vm._s(item.tag) + "]"]), _vm._s(item.title)])])
	  })])])])
	},staticRenderFns: []}
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-3484898a", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  return _h('div', [_h('Left')])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-3ca3e1ce", module.exports)
	  }
	}
