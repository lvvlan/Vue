...
/***/ function(module, exports, __webpack_require__) {
	...
	* */
	 ...
	 * Update 2016/12/23
	 */
	var list = [{ id: 1, text: 'this is test text1', done: true }, { id: 2, text: 'this is test text2', done: false }, { id: 3, text: 'this is test text3', done: true }, { id: 4, text: 'this is test text4', done: false }, { id: 5, text: 'this is test text5', done: true }, { id: 6, text: 'this is test text6', done: false }];
	...
	var store = new _vuex2.default.Store({
	    ...
	    mutations: {
	        ...
	        doneTodosOdd: function doneTodosOdd(state) {
	            state.todos = list.filter(function (todo) {
	                return todo.done;
	            });
	            console.log(list);
	        },
	        doneTodosEven: function doneTodosEven(state) {
	            state.todos = list.filter(function (todo) {
	                return !todo.done;
	            });
	            console.log(list);
	        },
	        AMutation: function AMutation(state) {
	            return state.message = 'message被AMutation更改';
	        },
	        BMutation: function BMutation(state, obj) {
	            console.log(obj);
	            state.message = obj.message;
	        }
	    },
	    actions: {
	        odd: function odd(_ref) {
	            var commit = _ref.commit;
	            //参数是一个与store实例具有相同方法和属性的context对象 ，可以用参数解构来简化代码
	            setTimeout(function () {
	                commit('doneTodosOdd');
	            }, 2000);
	        },
	        even: function even(_ref2) {
	        ...
	        AAction: function () {
	            var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref4) {
	        ...
	        BAction: function () {
	            var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(_ref6) {
	...
	new _vue2.default({
	    el: '#app',
	    components: { Actions: _actions2.default },
	    store: store //将store注入到组件里面  类似react-redux里面的provide把store传给每个组件
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "E:\\more and more\\VUE\\12-Vuex\\actions\\src\\component\\actions.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-afc0b072"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-afc0b072", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-afc0b072", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] actions.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-afc0b072&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./actions.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-afc0b072&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./actions.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    computed: (0, _extends3.default)({}, (0, _vuex.mapState)(['todos', 'num', 'message'])),
	    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(['odd', 'even', 'test', 'AAction', 'BAction']))
	}; //
	//
	//
	//
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  return _h('div', [_h('h2', ["Getters"]), " ", _h('button', {
	    on: {
	      "click": _vm.odd
	    }
	  }, ["odd"]), " ", _h('button', {
	  ...
	  }, ["test"]), " ", _h('p', [_vm._s(_vm.num)]), " ", _h('ul', [_vm._l((_vm.todos), function(todo) {
	    return _h('li', [_vm._s(todo.text)])
	  })]), " ", _h('div', {
	    attrs: {
	      "id": "demo"
	    }
	  ...
	  }, ["B内容"]), " ", _h('p', [_vm._s(_vm.message)])])])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-afc0b072", module.exports)
	  }
	}
