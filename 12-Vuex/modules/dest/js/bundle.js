...
/***/ function(module, exports, __webpack_require__) {
	...
	var _increment = __webpack_require__(49);

	var _increment2 = _interopRequireDefault(_increment);

	var _decrement = __webpack_require__(50);
	...
	var store = new _vuex2.default.Store({
	    ...
	    mutations: {
	        commonIncrement: function commonIncrement(state) {
	            return state.num++;
	        },
	        commonDecrement: function commonDecrement(state) {
	            return state.num--;
	        },
	        changeMessage: function changeMessage(state, _ref) {
	            var msg = _ref.msg;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "E:\\more and more\\VUE\\12-Vuex\\modules\\src\\component\\App.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-589862d5"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-589862d5", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-589862d5", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-589862d5&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-589862d5&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    computed: (0, _extends3.default)({}, (0, _vuex.mapState)(['num', 'message', 'increment', 'decrement'])),
	    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(['incrementAction', 'decrementAction']))
	}; //
	//
	//
	//
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  return _h('div', [_h('h2', [_vm._s(_vm.message)]), " ", _h('p', ["common num => " + _vm._s(_vm.num)]), " ", _h('button', {
	    ...
	    on: {
	      "click": _vm.decrementAction
	    }
	  }, ["-"]), " ", _h('p', ["increment num => " + _vm._s(_vm.increment.num) + " (incrementNum每次自增)"]), " ", _h('p', ["decrement num => " + _vm._s(_vm.decrement.num) + " (decrementNum每次递减)"])])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-589862d5", module.exports)
	  }
	}
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    mutations: {
	        ...
	        localIncrement: function localIncrement(state) {
	            return state.num++;
	        }
	        //incrementChangeMessage: state => state.message = state.increment.message
	    },
	    actions: {
	        incrementAction: function incrementAction(_ref) {
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    mutations: {
	        localDecrement: function localDecrement(state) {
	            return state.num--;
	        }
	    },
	    actions: {
	        decrementAction: function decrementAction(_ref) {
	            var commit = _ref.commit,
	                state = _ref.state;
